...
from multiplataform_development_i.domain.dto.dtos import UsuarioCreateDTO, UsuarioDTO, UsuarioUpdateDTO
from multiplataform_development_i.domain.model.models import Usuario
